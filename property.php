                            ...
                            <div class="col-md-6">
                                <div class="featured-thumb hover-zoomer mb-4">
                                    <div class="overlay-black overflow-hidden position-relative"> <img src="admin/property/<?php echo $row['15'];?>" alt="pimage">
                                        ...
                                        <div class="sale bg-success text-white"><?php echo $row['18'];?></div>
                                        <div class="price text-primary text-capitalize">Rp.<?php echo $row['9'];?></div>
                    ...
                    <div class="col-lg-4">
						...
						<form class="d-inline-block w-100" action="calc.php" method="post">
                            ...
                            <div class="input-group mb-2 mr-sm-2">
                                ...
                                <input type="text" class="form-control" name="amount" placeholder="Harga Properti">
                            </div>
                            ...
                            <div class="input-group mb-2 mr-sm-2">
                                ...
                                <input type="text" class="form-control" name="month" placeholder="Durasi/bulan">
                            </div>
                            ...
                            <div class="input-group mb-2 mr-sm-2">
                                ...
                                <input type="text" class="form-control" name="interest" placeholder="Suku Bunga">
                            </div>
