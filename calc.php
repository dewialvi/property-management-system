					...
					<table class="items-list col-lg-6 table-hover" style="border-collapse:inherit;">
                        <thead>
                             <tr  class="bg-secondary">
                                <th class="text-white font-weight-bolder">Ketentuan</th>
                                <th class="text-white font-weight-bolder">Jumlah</th>
                             </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr class="text-center font-18">
                                <td><b>Jumlah</b></td>
                                <td><b><?php echo 'Rp'.$amount ; ?></b></td>
                            </tr>
							<tr class="text-center">
                                <td><b>Total Durasi</b></td>
                                <td><b><?php echo $mon.' Bulan' ; ?></b></td>
							...
							<tr class="text-center">
                                ...
                                <td><b><?php echo 'Rp'.$interest ; ?></b></td>
                            </tr>
							<tr class="text-center">
                                <td><b>Total Jumlah</b></td>
                                <td><b><?php echo 'Rp'.$pay ; ?></b></td>
                            </tr>
							<tr class="text-center">
                                <td><b>Bayar Per Bulan (EMI)</b></td>
                                <td><b><?php echo 'Rp'.$month ; ?></b></td>
                            </tr>
