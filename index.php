...
<div id="page-wrapper">
    <div class="row"> 
                ...
                <div class="row h-100 align-items-center">
                    <div class="col-lg-12">
                        <div class="text-white">
                            <h1 class="mb-4"><span class="text-success">Rumah Ningrat</span><br>
                            #SemuaBisaPunyaRumah</h1><!-- FOR MORE PROJECTS visit: codeastro.com -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-4"><!-- FOR MORE PROJECTS visit: codeastro.com -->
                                        <div class="featured-thumb hover-zoomer mb-4">
                                            <div class="overlay-black overflow-hidden position-relative"> <img src="admin/property/<?php echo $row['15'];?>" alt="pimage">
                                                <div class="sale bg-success text-white text-capitalize"> <?php echo $row['18'];?></div>
                                                <div class="price text-primary"><b>Rp.<?php echo $row['9'];?> </b><span class="text-white"><?php echo $row['12'];?></span></div>
                                            </div>
                                            <div class="featured-thumb-data shadow-one">
                                                ...
                                                <div class="bg-gray quantity px-4 pt-4">
                                                    <ul>
                                                        <li><span><?php echo $row['5'];?></span> Kamar Tidur</li>
                                                        <li><span><?php echo $row['6'];?></span> Kamar Mandi</li>
                                                        <li><span><?php echo $row['7'];?></span> Garasi</li>
                                                        <li><span><?php echo $row['8'];?></span> Ukuran Rumah</li>
        ...
        <!--	Why Choose Us -->
        <div class="full-row living bg-one overlay-secondary-half" style="background-image: url('images/aboutrumah01.png'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-lg-6">
                        <div class="living-list pr-4">
                            <h3 class="pb-4 mb-3 text-white">Kelebihan Rumah Ningrat</h3>
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-medal flat-medium float-left d-table mr-4 text-success" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">Berpengalaman</h5>
										<p>Rumah Ningrat sudah berdiri sejak tahun 2013 dan sudah menjual 50++ Project Perumahan.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-real-estate flat-medium float-left d-table mr-4 text-success" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">Kredibel</h5>
										<p>Rumah Ningrat Berhasil Menjadi Pemenang Award Developer Terbaik Nasional.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-real-estate flat-medium float-left d-table mr-4 text-success" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">Tersedia di Banyak Kota</h5>
										<p>Rumah Ningrat sudah ada di 7 Kota yaitu Cirebon, Kuningan, Majalengka, Indramayu, Subang, Bekasi dan Kendal.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-seller flat-medium float-left d-table mr-4 text-success" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">Proses Cepat & Mudah</h5>
										<p>Konsumen akan dibantu oleh Tim Markerting Handal dan Berpengalaman dengan Mengedepankan Teknologi di Semua Prosesnya sehingga Proses Pembelian Cepat dan Mudah.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-real-estate flat-medium float-left d-table mr-4 text-success" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">Desain Terbaik</h5>
										<p>Rumah Ningrat menawarkan Rumah Subsidi dengan Desain Minimalis dan Elegan.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-seller flat-medium float-left d-table mr-4 text-success" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">Kualitas Terbaik</h5>
										<p>Rumah Ningrat menggunakan Material Terbaik dalam membangun produknya. Selain itu Rumah Ningrat memiliki program Garansi Bangunan senilai 20 juta dimana Rumah Ningrat mengedepankan Jaminan Kualitas.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-reward flat-medium float-left d-table mr-4 text-success" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">Lingkungan Aman & Nyaman</h5>
										<p>Perumahan Subsidi Rumah Ningrat dilengkapi dengan One gate System, Security 24 Jam, CCTV dan Gratis Biaya Iuran Pengelolaan Lingkungan.</p>
									</div>
                                </li>
                            </ul>
                        </div>
					...
					<div class="col-lg-12">
						<div class="content-sidebar p-4">
							<div class="mb-3 col-lg-12">
								<h4 class="double-down-line-left text-secondary position-relative pb-4 mb-4">Testimoni</h4>
									<div class="recent-review owl-carousel owl-dots-gray owl-dots-hover-success">
										...
										<div class="item">
											...
											<div class="p-2 mt-4">
												<span class="text-success d-table text-capitalize">Anonymous</span> 
											</div>
										</div>
										<?php }  ?>
