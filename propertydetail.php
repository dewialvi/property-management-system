...
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="description" content="Rumah Ningrat Property">
            ...
            <div class="container">
                <div class="row"><!-- FOR MORE PROJECTS visit: codeastro.com -->
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <div class="bg-success d-table px-3 py-2 rounded text-white text-capitalize"><?php echo $row['18'];?></div>
                            ...
                            <div class="col-md-6">
                                <div class="text-success text-left h5 my-2 text-md-right">Rp.<?php echo $row['9'];?></div>
                                <div class="text-left text-md-right">Harga</div>
                            </div>
                        </div>
                        <div class="property-details">
                            <div class="bg-gray property-quantity px-4 pt-4 w-100">
                                <ul>
                                    <li><span class="text-secondary"><?php echo $row['8'];?></span> Ukuran Rumah (m2)</li>
                                    <li><span class="text-secondary"><?php echo $row['5'];?></span> Kamar Tidur</li>
                                    <li><span class="text-secondary"><?php echo $row['6'];?></span> Kamar Mandi</li>
                                    <li><span class="text-secondary"><?php echo $row['7'];?></span> Garasi</li>
                                    <li><span class="text-secondary"><?php echo $row['10'];?></span> Luas Tanah (m2)</li>
                                    <li><span class="text-secondary"><?php echo $row['3'];?></span> Type</li>
                                </ul>
                            </div>
                            <h4 class="text-secondary my-4">Deskripsi</h4>
                            <p><?php echo $row['2'];?></p>
                            
                            <h5 class="mt-5 mb-4 text-secondary">Ringkasan Property </h5>
                            ...
                            <h5 class="mt-5 mb-4 text-secondary">Detail Tambahan</h5>
                            <div class="row">
								<?php echo $row['11'];?>
                                    ...
                                    <div class="col-sm-8 col-lg-9">
                                        <div class="agent-data text-ordinary mt-sm-20">
                                            ...
                                            <div class="mt-3 text-secondary hover-text-success">
                                                <ul>
                                                    <li class="float-left mr-3"><a href="https://wa.me/<?php echo $row['uphone']; ?>" target="_blank"><i class="fab fa-whatsapp" style="color: #25D366;"></i></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Deskripsi tambahan untuk customer -->
                <div class="alert alert-info mt-4">
                    <p>
                        <strong>Informasi untuk Customer:</strong> Jika Anda tertarik dengan properti ini, silakan hubungi agen terlebih dahulu melalui WhatsApp yang tertera untuk mendapatkan informasi lebih lanjut atau untuk melanjutkan pembelian. Agen kami siap membantu Anda!
                    </p>
                </div>
                                    <!-- FOR MORE PROJECTS visit: codeastro.com -->
                                </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <ul class="property_list_widget">
                            ...
                            $query=mysqli_query($con,"SELECT * FROM `property` WHERE isFeatured = 1 ORDER BY date DESC LIMIT 3");
                                    ...
                                    {
                            ?>
                            <li> <img src="admin/property/<?php echo $row['15'];?>" alt="pimage">
